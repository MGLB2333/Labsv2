    ...
    <Box>
      ...
      <Paper sx={{ p: 4, boxShadow: 'none', border: '1px solid #e0e0e0' }}>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
          ...
          {/* Dentsu Total TV Logo */}
          <Box sx={{ flex: '1 1 300px', minWidth: 300 }}>
            <Card
              sx={{
                border: selectedLogo === 'dentsu' ? '2px solid #02b5e7' : '1px solid #e0e0e0',
                borderRadius: 2,
                backgroundColor: selectedLogo === 'dentsu' ? 'rgba(2, 181, 231, 0.02)' : '#fff',
                transition: 'all 0.2s ease',
                '&:hover': {
                  borderColor: '#02b5e7',
                  backgroundColor: 'rgba(2, 181, 231, 0.02)',
            ...
            >
              <CardActionArea onClick={() => handleLogoSelect('dentsu')}>
                <CardContent sx={{ p: 3, textAlign: 'center' }}>
                  <Box sx={{ position: 'relative', mb: 2 }}>
                    <Box
                      sx={{
                    ...
                    >
                      <Box
                        component="img"
                        src="/DentsuTotalTVlogo (1).png"
                        alt="Dentsu Total TV Logo"
                        sx={{
                          height: 40,
                          width: 'auto',
                          maxWidth: '100%',
                  ...
                  <Typography variant="body2" sx={{ fontSize: '11px', color: '#666', lineHeight: 1.4 }}>
                    Use the Dentsu Total TV branding and logo
                  </Typography>
                </CardContent>
              </CardActionArea>
            </Card>
